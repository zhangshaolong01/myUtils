...
public class DownUtil {
	...
	public void download() throws Exception {
		...
		*/
		conn.setRequestMethod("GET");
		conn.setRequestProperty("User-Agent", "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3521.2 Safari/537.36");
		...
		public void run() {
			try {
				...
				*/
				...
				// System.out.println(getName()+" length "+length+" currentPartSize
				// "+currentPartSize);
